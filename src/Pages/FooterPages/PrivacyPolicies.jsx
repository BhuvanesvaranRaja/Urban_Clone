  ...
  return (
    <>
      ...
      <div className="text-justify m-5 p-4 fs-5">
        <ul>
          <li className="p-3">
            Your privacy is important to us. We only retain collected
            information for as long as necessary to provide you with your
            requested service. What data we store, We only retain collected
            information for as long as necessary to provide you with your
            ...
            only retain collected information for as long as necessary to
            provide you with your requested service. What data we store, we’ll
            protect within commercially acceptable means to prevent loss and
            theft, as well as unauthorized access, disclosure, copying, use, or
            modification. We only retain collected information for as long as
            ...
            use, or modification. we’ll protect within commercially acceptable
            means to prevent loss and theft, as well as unauthorized access,
            disclosure, copying, use, or modification. It is U-company's policy
            to respect your privacy regarding any information we may collect
            from you across our website, www.u-company.com, and other sites we
            own and operate.
          </li>
          <li className="p-3">
            ...
            collecting it and how it will be used. Your continued use of our
            website will be regarded as acceptance of our practices around
            privacy and personal information. If you have any questions about
            how we handle user data and personal information, feel free to
            contact us.
          </li>
          <li className="p-3">
          ...
          <li className="p-3">
            ...
            liability for their respective p We only retain collected
            information for as long as necessary to provide you with your
            requested service. What data we store, we’ll protect within
            commercially acceptable means to prevent loss and theft, as well as
            unauthorized access, disclosure, copying, use, or
            modification.rivacy policies. We only retain collected information
          ...
          <li className="p-3">
            This policy is effective as of 1 October 2023.
          </li>
        </ul>
      </div>
    </>
